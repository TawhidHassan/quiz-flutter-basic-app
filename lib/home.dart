...
import 'package:quizflutter/quizpage.dart';
...
class _homepageState extends State<homepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          customcard(lanName[0], images[0], des[0]),
          customcard(lanName[1], images[1], des[1]),
          customcard(lanName[2], images[2], des[2]),
          customcard(lanName[3],images[3], des[3]),
